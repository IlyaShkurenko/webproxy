<?php
/* Smarty version 3.1.29, created on 2018-02-09 17:03:09
  from "/srv/www/whmcs4.devcopy.blazingseollc.com/templates/six/viewinvoice.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5a7dd44d81fed4_89665743',
  'file_dependency' => 
  array (
    'd234ed947da30aadf86d1ce4de4a803169d8b74f' => 
    array (
      0 => '/srv/www/whmcs4.devcopy.blazingseollc.com/templates/six/viewinvoice.tpl',
      1 => 1518169945,
      2 => 'file',
    ),
  ),
...
function content_5a7dd44d81fed4_89665743 ($_smarty_tpl) {
...
<body>
		...
		<?php 
      $hookResult = run_hook('invoiceBlazingProxyUrl', [
        'invoiceid' => $template->getVariable('invoiceid')->value,
        'force' => $template->getVariable('paymentSuccess')->value
      ]);
      $template->assign('addProxyButton', !!$hookResult);
      if ($hookResult) {
        $template->assign('proxyUrl', $hookResult[0]['url']);
      }
    ?>
                ...
                <div class="col-sm-5 text-center">
                    ...
                    <div class="invoice-status">
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['status']->value == "Unpaid") {?>
	                          <?php if ($_smarty_tpl->tpl_vars['paymentSuccess']->value && $_smarty_tpl->tpl_vars['addProxyButton']->value) {?>
                              <span class="collections">Pending</span>
	                          <?php } else { ?>
...
?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['addProxyButton']->value) {?>
              <div class="row">
                <div class="col-sm-12 text-center">
                  <a href="<?php echo $_smarty_tpl->tpl_vars['proxyUrl']->value;?>
" class="btn btn-success btn-lg col-sm-6"
                     style="display: inline-block; float: none; line-height: 2; margin-top: -1.9em;">
                    <i class="fa fa-home"></i> Click Here To Get Proxies</a>
                  <br>
                  <br>
                </div>
              </div>
...
if ($_smarty_tpl->tpl_vars['item']->value['taxed'] == "true") {?> *<?php }?>
                                        </td>
