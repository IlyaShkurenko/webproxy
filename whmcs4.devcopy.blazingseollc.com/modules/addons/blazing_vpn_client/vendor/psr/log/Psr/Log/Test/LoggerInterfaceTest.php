...
namespace Blazing\Vpn\Client\Vendor\Psr\Log\Test;

use Blazing\Vpn\Client\Vendor\Psr\Log\LoggerInterface;
use Blazing\Vpn\Client\Vendor\Psr\Log\LogLevel;
/**
...
abstract class LoggerInterfaceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Blazing\\Vpn\\Client\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
    ...
    {
        $context = array('bool' => true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => array('with object' => new DummyTest()), 'object' => new \DateTime(), 'resource' => fopen('php://memory', 'r'));
