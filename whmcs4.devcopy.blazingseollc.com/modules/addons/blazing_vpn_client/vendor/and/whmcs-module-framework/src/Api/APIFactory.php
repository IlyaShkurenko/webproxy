...
class APIFactory
{
    protected static $classes = ['orders' => Orders::class, 'billing' => Billing::class, 'system' => System::class, 'client' => Client::class, 'service' => Service::class];
    ...
    protected static function getOrLoad($requestor)
    {
        ...
        if (empty(self::$instances[$class])) {
            if (!is_subclass_of($class, AbstractRequest::class)) {
                throw new RuntimeException(sprintf('Class must be an inheritor of %s, %s passed', AbstractRequest::class, $class));
            }
