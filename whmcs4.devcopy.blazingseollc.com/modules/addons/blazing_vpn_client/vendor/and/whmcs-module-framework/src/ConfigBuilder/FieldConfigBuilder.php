...
namespace Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder;

use Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder\Field\BoolFieldBuilder;
use Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder\Field\DropdownFieldBuilder;
use Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder\Field\PasswordFieldBuilder;
use Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder\Field\RadioFieldBuilder;
use Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder\Field\TextareaFieldBuilder;
use Blazing\Vpn\Client\Vendor\WHMCS\Module\Framework\ConfigBuilder\Field\TextFieldBuilder;
class FieldConfigBuilder extends AbstractConfigBuilder
{
    protected $config = ['FriendlyName' => null, 'Type' => 'text', 'Size' => null, 'Description' => null, 'Default' => null];
    // Types shortcuts
    /**
     * @param $key
     * @param $friendlyName
