...
namespace Blazing\Vpn\Client\Vendor\Buzz;
...
class Browser
{
    ...
    public function addListener(ListenerInterface $listener)
    {
        if (!$this->listener) {
            ...
            $this->listener = new ListenerChain(array($this->listener, $listener));
        }
    }
}