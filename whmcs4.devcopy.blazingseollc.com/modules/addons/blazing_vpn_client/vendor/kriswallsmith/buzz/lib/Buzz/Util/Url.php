...
namespace Blazing\Vpn\Client\Vendor\Buzz\Util;
...
class Url
{
    private static $defaultPorts = array('http' => 80, 'https' => 443);
    private $url;
    private $components;
    /**
     * Constructor.
    ...
    {
        static $map = array('s' => 'getScheme', 'u' => 'getUser', 'a' => 'getPassword', 'h' => 'getHostname', 'o' => 'getPort', 'p' => 'getPath', 'q' => 'getQueryString', 'f' => 'getFragment', 'H' => 'getHost', 'R' => 'getResource');
        $url = '';
