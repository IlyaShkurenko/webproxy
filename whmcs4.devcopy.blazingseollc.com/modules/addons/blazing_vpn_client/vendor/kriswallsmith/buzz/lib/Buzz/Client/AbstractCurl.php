...
use Blazing\Vpn\Client\Vendor\Buzz\Message\Form\FormRequestInterface;
use Blazing\Vpn\Client\Vendor\Buzz\Message\Form\FormUploadInterface;
...
abstract class AbstractCurl extends AbstractClient
{
    ...
    public function __construct()
    {
        if (defined('CURLOPT_PROTOCOLS')) {
            $this->options = array(CURLOPT_PROTOCOLS => CURLPROTO_HTTP | CURLPROTO_HTTPS, CURLOPT_REDIR_PROTOCOLS => CURLPROTO_HTTP | CURLPROTO_HTTPS);
        }
    }
    /**
