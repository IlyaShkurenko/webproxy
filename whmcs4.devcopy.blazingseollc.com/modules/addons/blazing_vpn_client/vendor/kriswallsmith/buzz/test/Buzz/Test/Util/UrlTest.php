...
namespace Blazing\Vpn\Client\Vendor\Buzz\Test\Util;
...
class UrlTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function providePattern()
    {
        ...
        $host = 'example.com';
        return array(array($full, 's://u:a@h:op?q#f', 'http://foo:bar@example.com:123/asdf?tweedle=dee#dum'), array($full, 'HR', 'http://example.com:123/asdf?tweedle=dee'), array($host, 'HR', 'http://example.com/'));
    }
}