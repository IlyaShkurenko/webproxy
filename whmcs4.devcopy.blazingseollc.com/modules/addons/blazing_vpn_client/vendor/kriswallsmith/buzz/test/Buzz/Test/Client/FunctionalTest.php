...
use Blazing\Vpn\Client\Vendor\Buzz\Client\BatchClientInterface;
use Blazing\Vpn\Client\Vendor\Buzz\Client\ClientInterface;
use Blazing\Vpn\Client\Vendor\Buzz\Client\Curl;
use Blazing\Vpn\Client\Vendor\Buzz\Client\FileGetContents;
use Blazing\Vpn\Client\Vendor\Buzz\Client\MultiCurl;
use Blazing\Vpn\Client\Vendor\Buzz\Message\Form\FormRequest;
use Blazing\Vpn\Client\Vendor\Buzz\Message\Form\FormUpload;
...
class FunctionalTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array(new Curl()), array(new FileGetContents()), array(new MultiCurl()));
    }
