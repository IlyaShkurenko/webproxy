 ...
 */
namespace Blazing\Vpn\Client\Vendor\Webmozart\Assert\Tests;
...
use stdClass;
use Blazing\Vpn\Client\Vendor\Webmozart\Assert\Assert;
/**
 * @since  1.0
 *
...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAssert($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        ...
        call_user_func_array(array('Blazing\\Vpn\\Client\\Vendor\\Webmozart\\Assert\\Assert', $method), $args);
    }
    /**
     * @dataProvider getTests
     */
    public function testNullOr($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        ...
        call_user_func_array(array('Blazing\\Vpn\\Client\\Vendor\\Webmozart\\Assert\\Assert', 'nullOr' . ucfirst($method)), $args);
    }
    /**
    ...
    {
        call_user_func(array('Blazing\\Vpn\\Client\\Vendor\\Webmozart\\Assert\\Assert', 'nullOr' . ucfirst($method)), null);
    }
    /**
     * @dataProvider getTests
     */
    public function testAllArray($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        ...
        call_user_func_array(array('Blazing\\Vpn\\Client\\Vendor\\Webmozart\\Assert\\Assert', 'all' . ucfirst($method)), $args);
    }
    /**
     * @dataProvider getTests
     */
