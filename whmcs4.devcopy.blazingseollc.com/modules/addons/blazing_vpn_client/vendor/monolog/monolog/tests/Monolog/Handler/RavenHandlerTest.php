...
use Blazing\Vpn\Client\Vendor\Monolog\Formatter\LineFormatter;
class RavenHandlerTest extends TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\RavenHandler', $handler);
    }
    ...
    public function testUserContext()
    {
        ...
        $user = array('id' => '123', 'email' => 'test@test.com');
    ...
    public function testHandleBatch()
    {
        ...
        $records[] = $this->getRecord(Logger::WARNING, 'warning');
        $logFormatter = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Formatter\\FormatterInterface');
    ...
    {
        $records = array($this->getRecord(Logger::DEBUG, 'debug message 1'), $this->getRecord(Logger::DEBUG, 'debug message 2'), $this->getRecord(Logger::INFO, 'information'));
        $handler = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\RavenHandler', null, array($this->getRavenClient()));
    ...
    {
        $records = array($this->getRecord(Logger::DEBUG, 'debug message 1'), $this->getRecord(Logger::DEBUG, 'debug message 2'), $this->getRecord(Logger::INFO, 'information 1'), $this->getRecord(Logger::ERROR, 'error 1'), $this->getRecord(Logger::WARNING, 'warning'), $this->getRecord(Logger::ERROR, 'error 2'), $this->getRecord(Logger::INFO, 'information 2'));
        $logFormatter = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Formatter\\FormatterInterface');
        $logFormatter->expects($this->once())->method('formatBatch');
        $formatter = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Formatter\\FormatterInterface');
