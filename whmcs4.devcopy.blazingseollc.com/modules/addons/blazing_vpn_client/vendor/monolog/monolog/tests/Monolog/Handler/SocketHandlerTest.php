...
class SocketHandlerTest extends TestCase
{
    ...
    public function testWriteFailsOnIfFwriteReturnsFalse()
    {
        ...
        $callback = function ($arg) {
            $map = array('Hello world' => 6, 'world' => false);
            return $map[$arg];
        };
    ...
    public function testWriteFailsIfStreamTimesOut()
    {
        ...
        $this->handler->expects($this->exactly(1))->method('streamGetMetadata')->will($this->returnValue(array('timed_out' => true)));
        $this->writeRecord('Hello world');
    }
    /**
     * @expectedException RuntimeException
    ...
    public function testWriteFailsOnIncompleteWrite()
    {
        ...
        $this->handler->expects($this->exactly(1))->method('fwrite')->will($this->returnCallback($callback));
        $this->handler->expects($this->exactly(1))->method('streamGetMetadata')->will($this->returnValue(array('timed_out' => false)));
        $this->writeRecord('Hello world');
    }
    ...
    {
        $this->setMockHandler(array('fwrite', 'streamGetMetadata'));
        $this->handler->expects($this->any())->method('fwrite')->will($this->returnValue(0));
        $this->handler->expects($this->any())->method('streamGetMetadata')->will($this->returnValue(array('timed_out' => false)));
    ...
    private function setMockHandler(array $methods = array())
    {
        ...
        $this->handler = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\SocketHandler', $finalMethods, array('localhost:1234'));
