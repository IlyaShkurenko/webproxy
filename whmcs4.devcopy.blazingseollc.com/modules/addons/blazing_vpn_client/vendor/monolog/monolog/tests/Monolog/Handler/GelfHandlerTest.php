...
use Blazing\Vpn\Client\Vendor\Monolog\Formatter\GelfMessageFormatter;
class GelfHandlerTest extends TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\GelfHandler', $handler);
    }
