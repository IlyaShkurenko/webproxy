...
class WebProcessorTest extends TestCase
{
    ...
    {
        $server = array('REQUEST_URI' => 'A', 'REMOTE_ADDR' => 'B', 'REQUEST_METHOD' => 'C', 'HTTP_REFERER' => 'D', 'SERVER_NAME' => 'F', 'UNIQUE_ID' => 'G');
    ...
    {
        $server = array('REMOTE_ADDR' => 'B', 'REQUEST_METHOD' => 'C');
        $processor = new WebProcessor($server);
        $record = $processor($this->getRecord());
    ...
    {
        $server = array('REQUEST_URI' => 'A', 'REMOTE_ADDR' => 'B', 'REQUEST_METHOD' => 'C', 'SERVER_NAME' => 'F');
        $processor = new WebProcessor($server);
        $record = $processor($this->getRecord());
