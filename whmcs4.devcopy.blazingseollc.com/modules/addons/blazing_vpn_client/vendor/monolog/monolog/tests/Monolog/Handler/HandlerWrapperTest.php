...
class HandlerWrapperTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->handler = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\HandlerInterface');
    ...
    public function testIsHandling($result)
    {
        ...
        $this->handler->expects($this->once())->method('isHandling')->with($record)->willReturn($result);
    ...
    {
        $record = $this->getRecord();
        $this->handler->expects($this->once())->method('handle')->with($record)->willReturn($result);
    ...
    public function testPushProcessor()
    {
        ...
        $this->handler->expects($this->once())->method('pushProcessor')->with($processor);
    ...
    public function testPopProcessor()
    {
        ...
        $this->handler->expects($this->once())->method('popProcessor')->willReturn($processor);
