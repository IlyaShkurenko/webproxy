...
class AbstractHandlerTest extends TestCase
{
    ...
    {
        $handler = $this->getMockForAbstractClass('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractHandler', array(Logger::WARNING, false));
    ...
    {
        $handler = $this->getMockForAbstractClass('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractHandler');
    ...
    {
        $handler = $this->getMockForAbstractClass('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractHandler', array('warning', false));
        $this->assertFalse($handler->isHandling($this->getRecord(Logger::DEBUG)));
    ...
    {
        $handler = $this->getMockForAbstractClass('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractHandler');
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Formatter\\LineFormatter', $handler->getFormatter());
    }
    /**
    ...
    {
        $logger = $this->getMockForAbstractClass('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractHandler');
