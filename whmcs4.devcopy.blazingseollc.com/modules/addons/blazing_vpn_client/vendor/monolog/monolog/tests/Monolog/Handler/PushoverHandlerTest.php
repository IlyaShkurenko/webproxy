...
class PushoverHandlerTest extends TestCase
{
    ...
    private function createHandler($token = 'myToken', $user = 'myUser', $title = 'Monolog')
    {
        ...
        $this->handler = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\PushoverHandler', array('fsockopen', 'streamSetTimeout', 'closeSocket'), $constructorArgs);
