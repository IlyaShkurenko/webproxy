...
class SlackbotHandlerTest extends TestCase
{
    ...
    public function testConstructorMinimal()
    {
        ...
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractProcessingHandler', $handler);
    }
    /**
     * @covers ::__construct
     */
    ...
    {
        $handler = new SlackbotHandler('test-team', 'test-token', 'test-channel', Logger::DEBUG, false);
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\AbstractProcessingHandler', $handler);
    }
}