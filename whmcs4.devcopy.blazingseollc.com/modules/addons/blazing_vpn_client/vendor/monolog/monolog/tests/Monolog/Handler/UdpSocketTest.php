...
use Blazing\Vpn\Client\Vendor\Monolog\Handler\SyslogUdp\UdpSocket;
/**
...
class UdpSocketTest extends TestCase
{
    ...
    {
        $socket = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\SyslogUdp\\UdpSocket', array('send'), array('lol', 'lol'));
