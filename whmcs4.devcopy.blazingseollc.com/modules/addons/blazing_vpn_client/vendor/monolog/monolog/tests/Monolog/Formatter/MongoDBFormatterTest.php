...
class MongoDBFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $record = array('message' => 'some log message', 'context' => array(), 'level' => Logger::WARNING, 'level_name' => Logger::getLevelName(Logger::WARNING), 'channel' => 'test', 'datetime' => new \DateTime('2014-02-01 00:00:00'), 'extra' => array());
    ...
    public function testRecursiveFormat()
    {
        ...
        $this->assertEquals(array('foo' => 'something', 'bar' => 'stuff', 'class' => 'stdClass'), $formattedRecord['context']['some_object']);
    ...
    {
        $record = array('message' => 'some log message', 'context' => array('nest2' => array('property' => 'anything', 'nest3' => array('nest4' => 'value', 'property' => 'nothing'))), 'level' => Logger::WARNING, 'level_name' => Logger::getLevelName(Logger::WARNING), 'channel' => 'test', 'datetime' => new \DateTime('2014-02-01 00:00:00'), 'extra' => array());
        $formatter = new MongoDBFormatter(2);
        $formattedResult = $formatter->format($record);
        $this->assertEquals(array('nest2' => array('property' => 'anything', 'nest3' => '[...]')), $formattedResult['context']);
    }
    public function testFormatDepthArrayInfiniteNesting()
    {
        ...
        $formattedResult = $formatter->format($record);
        $this->assertEquals(array('nest2' => array('property' => 'something', 'nest3' => array('property' => 'anything', 'nest4' => array('property' => 'nothing')))), $formattedResult['context']);
    }
    public function testFormatDepthObjects()
    {
        ...
        $record = array('message' => 'some log message', 'context' => array('nest2' => $someObject), 'level' => Logger::WARNING, 'level_name' => Logger::getLevelName(Logger::WARNING), 'channel' => 'test', 'datetime' => new \DateTime('2014-02-01 00:00:00'), 'extra' => array());
        $formatter = new MongoDBFormatter(2, true);
        $formattedResult = $formatter->format($record);
        $this->assertEquals(array('nest2' => array('property' => 'anything', 'nest3' => '[...]', 'class' => 'stdClass')), $formattedResult['context']);
    }
