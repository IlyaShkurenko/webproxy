...
use Blazing\Vpn\Client\Vendor\Monolog\Formatter\FlowdockFormatter;
...
class FlowdockHandlerTest extends TestCase
{
    ...
    private function createHandler($token = 'myToken')
    {
        ...
        $this->handler = $this->getMock('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Handler\\FlowdockHandler', array('fsockopen', 'streamSetTimeout', 'closeSocket'), $constructorArgs);
