...
use Blazing\Vpn\Client\Vendor\Monolog\Formatter\ElasticaFormatter;
use Blazing\Vpn\Client\Vendor\Monolog\Formatter\NormalizerFormatter;
...
class ElasticSearchHandlerTest extends TestCase
{
    ...
    public function testSetFormatter()
    {
        ...
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Monolog\\Formatter\\ElasticaFormatter', $handler->getFormatter());
    ...
    {
        return array(array(false, array('RuntimeException', 'Error sending messages to Elasticsearch')), array(true, false));
    }
    /**
