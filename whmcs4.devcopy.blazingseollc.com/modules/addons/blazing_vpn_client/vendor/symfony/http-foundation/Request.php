 ...
 */
namespace Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation;

use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Session\SessionInterface;
/**
...
class Request
{
    ...
    /** @deprecated since version 3.3, to be removed in 4.0 */
    private static $trustedHeaderNames = array(self::HEADER_FORWARDED => 'FORWARDED', self::HEADER_CLIENT_IP => 'X_FORWARDED_FOR', self::HEADER_CLIENT_HOST => 'X_FORWARDED_HOST', self::HEADER_CLIENT_PROTO => 'X_FORWARDED_PROTO', self::HEADER_CLIENT_PORT => 'X_FORWARDED_PORT');
    private static $forwardedParams = array(self::HEADER_X_FORWARDED_FOR => 'for', self::HEADER_X_FORWARDED_HOST => 'host', self::HEADER_X_FORWARDED_PROTO => 'proto', self::HEADER_X_FORWARDED_PORT => 'host');
    /**
