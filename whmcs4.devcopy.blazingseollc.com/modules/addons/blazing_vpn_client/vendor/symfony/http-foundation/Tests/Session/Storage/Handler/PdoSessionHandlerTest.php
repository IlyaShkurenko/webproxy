...
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Session\Storage\Handler\PdoSessionHandler;
/**
...
class PdoSessionHandlerTest extends TestCase
{
    ...
    public function testReadConvertsStreamToString()
    {
        ...
        $pdo->prepareResult->expects($this->once())->method('fetchAll')->will($this->returnValue(array(array($stream, 42, time()))));
        $storage = new PdoSessionHandler($pdo);
