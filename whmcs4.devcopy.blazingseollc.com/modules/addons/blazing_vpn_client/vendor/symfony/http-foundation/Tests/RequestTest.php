 ...
 */
namespace Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Tests;

use PHPUnit\Framework\TestCase;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Session\Session;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Request;
class RequestTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $request = Request::create('http://test.com/apparthotel-1234', 'GET', array(), array(), array(), array('DOCUMENT_ROOT' => '/var/www/www.test.com', 'SCRIPT_FILENAME' => '/var/www/www.test.com/app/app.php', 'SCRIPT_NAME' => '/app/app.php', 'PHP_SELF' => '/app/app.php/apparthotel-1234'));
    ...
    public function testCreateCheckPrecedence()
    {
        ...
        $request = Request::create('/', 'DELETE', array(), array(), array(), array('HTTP_HOST' => 'example.com', 'HTTPS' => 'on', 'SERVER_PORT' => 443, 'PHP_AUTH_USER' => 'fabien', 'PHP_AUTH_PW' => 'pa$$', 'QUERY_STRING' => 'foo=bar', 'CONTENT_TYPE' => 'application/json'));
        ...
        $request = Request::create('http://thomas:pokemon@example.net:8080/?foo=bar', 'GET', array(), array(), array(), array('HTTP_HOST' => 'example.com', 'HTTPS' => 'on', 'SERVER_PORT' => 443));
    ...
    {
        return array_merge(array(array(null, array(null, 'unexistent-mime-type'))), $this->getFormatToMimeTypeMapProvider());
    }
    ...
    public function testGetUri()
    {
        ...
        $server = array('HTTP_HOST' => 'host:8080', 'SERVER_NAME' => 'servername', 'SERVER_PORT' => '8080', 'QUERY_STRING' => 'query=string', 'REQUEST_URI' => '/ba%20se/index_dev.php/foo%20bar/in+fo?query=string', 'SCRIPT_NAME' => '/ba se/index_dev.php', 'PATH_TRANSLATED' => 'redirect:/index.php/foo bar/in+fo', 'PHP_SELF' => '/ba se/index_dev.php/path/info', 'SCRIPT_FILENAME' => '/some/where/ba se/index_dev.php');
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    {
        return array(array('me.png', '/foo', '/me.png'), array('../me.png', '/foo/bar', '/me.png'), array('me.png', '/foo/bar', '/foo/me.png'), array('../baz/me.png', '/foo/bar/b', '/foo/baz/me.png'), array('../../fooz/baz/me.png', '/foo/bar/b', '/fooz/baz/me.png'), array('baz/me.png', '/foo/bar/b', 'baz/me.png'));
    }
    ...
    {
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => 'https', 'HTTP_X_FORWARDED_PORT' => '443'));
        ...
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => 'https', 'HTTP_X_FORWARDED_PORT' => '8443'));
        ...
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => 'https'));
        ...
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => 'http'));
        ...
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => 'On'));
        ...
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => '1'));
        ...
        $request = Request::create('http://example.com', 'GET', array(), array(), array(), array('HTTP_X_FORWARDED_PROTO' => 'something-else'));
        $port = $request->getPort();
    ...
    public function getClientIpsForwardedProvider()
    {
        ...
        return array(array(array('127.0.0.1'), '127.0.0.1', 'for="_gazonk"', null), array(array('127.0.0.1'), '127.0.0.1', 'for="_gazonk"', array('127.0.0.1')), array(array('88.88.88.88'), '127.0.0.1', 'for="88.88.88.88:80"', array('127.0.0.1')), array(array('192.0.2.60'), '::1', 'for=192.0.2.60;proto=http;by=203.0.113.43', array('::1')), array(array('2620:0:1cfe:face:b00c::3', '192.0.2.43'), '::1', 'for=192.0.2.43, for=2620:0:1cfe:face:b00c::3', array('::1')), array(array('2001:db8:cafe::17'), '::1', 'for="[2001:db8:cafe::17]:4711', array('::1')));
    }
    public function getClientIpsProvider()
    {
        //        $expected                   $remoteAddr                $httpForwardedFor            $trustedProxies
        return array(array(array('88.88.88.88'), '88.88.88.88', null, null), array(array('88.88.88.88'), '88.88.88.88', null, array('88.88.88.88')), array(array('::1'), '::1', null, null), array(array('::1'), '::1', null, array('::1')), array(array('127.0.0.1'), '127.0.0.1', '88.88.88.88', null), array(array('88.88.88.88'), '127.0.0.1', '88.88.88.88', array('127.0.0.1')), array(array('88.88.88.88'), '127.0.0.1', '88.88.88.88', array('127.0.0.1', '88.88.88.88')), array(array('88.88.88.88'), '123.45.67.89', '88.88.88.88', array('123.45.67.0/24')), array(array('1620:0:1cfe:face:b00c::3'), '1620:0:1cfe:face:b00c::3', '2620:0:1cfe:face:b00c::3', null), array(array('2620:0:1cfe:face:b00c::3'), '1620:0:1cfe:face:b00c::3', '2620:0:1cfe:face:b00c::3', array('1620:0:1cfe:face:b00c::3')), array(array('88.88.88.88'), '2a01:198:603:0:396e:4789:8e99:890f', '88.88.88.88', array('2a01:198:603:0::/65')), array(array('88.88.88.88', '87.65.43.21', '127.0.0.1'), '123.45.67.89', '127.0.0.1, 87.65.43.21, 88.88.88.88', array('123.45.67.89')), array(array('87.65.43.21', '127.0.0.1'), '123.45.67.89', '127.0.0.1, 87.65.43.21, 88.88.88.88', array('123.45.67.89', '88.88.88.88')), array(array('88.88.88.88', '127.0.0.1'), '123.45.67.89', '127.0.0.1, 87.65.43.21, 88.88.88.88', array('123.45.67.89', '87.65.43.21')), array(array('127.0.0.1'), '123.45.67.89', '127.0.0.1, 87.65.43.21, 88.88.88.88', array('123.45.67.89', '87.65.43.21', '88.88.88.88', '127.0.0.1')), array(array('2620:0:1cfe:face:b00c::3', '3620:0:1cfe:face:b00c::3'), '1620:0:1cfe:face:b00c::3', '3620:0:1cfe:face:b00c::3,2620:0:1cfe:face:b00c::3', array('1620:0:1cfe:face:b00c::3')), array(array('3620:0:1cfe:face:b00c::3'), '1620:0:1cfe:face:b00c::3', '3620:0:1cfe:face:b00c::3,2620:0:1cfe:face:b00c::3', array('1620:0:1cfe:face:b00c::3', '2620:0:1cfe:face:b00c::3')), array(array('2620:0:1cfe:face:b00c::3', '4620:0:1cfe:face:b00c::3'), '1620:0:1cfe:face:b00c::3', '4620:0:1cfe:face:b00c::3,3620:0:1cfe:face:b00c::3,2620:0:1cfe:face:b00c::3', array('1620:0:1cfe:face:b00c::3', '3620:0:1cfe:face:b00c::3')), array(array('88.88.88.88'), '127.0.0.1', '88.88.88.88:12345, 127.0.0.1', array('127.0.0.1')), array(array('88.88.88.88'), '127.0.0.1', 'unknown,88.88.88.88', array('127.0.0.1')), array(array('88.88.88.88'), '127.0.0.1', '}__test|O:21:&quot;JDatabaseDriverMysqli&quot;:3:{s:2,88.88.88.88', array('127.0.0.1')));
    }
    /**
    ...
    {
        $request = new Request();
        $server = array('REMOTE_ADDR' => '88.88.88.88', 'HTTP_FORWARDED' => $httpForwarded, 'HTTP_X_FORWARDED_FOR' => $httpXForwardedFor);
    ...
    public function getClientIpsWithConflictingHeadersProvider()
    {
        ...
        return array(array('for=87.65.43.21', '192.0.2.60'), array('for=87.65.43.21, for=192.0.2.60', '192.0.2.60'), array('for=192.0.2.60', '192.0.2.60,87.65.43.21'), array('for="::face", for=192.0.2.60', '192.0.2.60,192.0.2.43'), array('for=87.65.43.21, for=192.0.2.60', '192.0.2.60,87.65.43.21'));
    }
    /**
    ...
    {
        return array('Resource then fetch' => array(true, false), 'Resource then resource' => array(true, true));
    }
    /**
    ...
    {
        return array('Fetch then fetch' => array(false, false), 'Fetch then resource' => array(false, true), 'Resource then fetch' => array(true, false), 'Resource then resource' => array(true, true));
    }
    public function provideOverloadedMethods()
    {
        return array(array('PUT'), array('DELETE'), array('PATCH'), array('put'), array('delete'), array('patch'));
    }
    /**
    ...
    {
        return array(array('foo', 'foo', 'foo'), array('fo%6f', 'foo', 'fo%6f'), array('foo/bar', 'foo', 'foo'), array('fo%6f/bar', 'foo', 'fo%6f'), array('f%6f%6f/bar', 'foo', 'f%6f%6f'), array('%66%6F%6F/bar', 'foo', '%66%6F%6F'), array('fo+o/bar', 'fo+o', 'fo+o'), array('fo%2Bo/bar', 'fo+o', 'fo%2Bo'));
    }
    private function disableHttpMethodParameterOverride()
    {
        $class = new \ReflectionClass('Blazing\\Vpn\\Client\\Vendor\\Symfony\\Component\\HttpFoundation\\Request');
    ...
    {
        return array(array('.a', false), array('a..', false), array('a.', true), array("é", false), array('[::1]', true), array('[::1]:80', true, '[::1]', 80), array(str_repeat('.', 101), false));
    }
    public function getLongHostNames()
    {
        return array(array('a' . str_repeat('.a', 40000)), array(str_repeat(':', 101)));
    }
    /**
    ...
    {
        return array(array('HEAD', true), array('GET', true), array('POST', false), array('PUT', true), array('PATCH', false), array('DELETE', true), array('PURGE', true), array('OPTIONS', true), array('TRACE', true), array('CONNECT', false));
    }
    /**
    ...
    {
        return array(array('HEAD', true), array('GET', true), array('POST', false), array('PUT', false), array('PATCH', false), array('DELETE', false), array('PURGE', false), array('OPTIONS', true), array('TRACE', true), array('CONNECT', false));
    }
    /**
     * @group legacy
    ...
    {
        return array(array('HEAD', true), array('GET', true), array('POST', false), array('PUT', false), array('PATCH', false), array('DELETE', false), array('PURGE', false), array('OPTIONS', false), array('TRACE', false), array('CONNECT', false));
    }
    /**
     * @group legacy
     */
