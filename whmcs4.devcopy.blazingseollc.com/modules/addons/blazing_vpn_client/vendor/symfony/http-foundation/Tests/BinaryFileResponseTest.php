...
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\BinaryFileResponse;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\File\Stream;
...
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Tests\File\FakeFile;
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    {
        return array(array('bytes=1-4', 1, 4, 'bytes 1-4/35'), array('bytes=-5', 30, 5, 'bytes 30-34/35'), array('bytes=30-', 30, 5, 'bytes 30-34/35'), array('bytes=30-30', 30, 1, 'bytes 30-30/35'), array('bytes=30-34', 30, 5, 'bytes 30-34/35'));
    }
    ...
    {
        return array(array('bytes=0-'), array('bytes=0-34'), array('bytes=-35'), array('bytes=20-10'), array('bytes=50-40'));
    }
    /**
    ...
    {
        return array(array('bytes=-40'), array('bytes=30-40'));
    }
    /**
    ...
    {
        return array(array(__DIR__ . '/../README.md'), array('file://' . __DIR__ . '/../README.md'));
    }
    /**
    ...
    {
        return array(array('/var/www/var/www/files/foo.txt', '/var/www/=/files/', '/files/var/www/files/foo.txt'), array('/home/foo/bar.txt', '/var/www/=/files/,/home/foo/=/baz/', '/baz/bar.txt'));
    }
