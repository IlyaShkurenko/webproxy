...
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\ResponseHeaderBag;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Cookie;
/**
...
class ResponseHeaderBagTest extends TestCase
{
    ...
    public function testCookiesWithSameNames()
    {
        ...
        $this->assertEquals(array('foo=bar; path=/path/foo; domain=foo.bar; httponly', 'foo=bar; path=/path/bar; domain=foo.bar; httponly', 'foo=bar; path=/path/bar; domain=bar.foo; httponly', 'foo=bar; path=/; httponly'), $bag->get('set-cookie', null, false));
    ...
    public function testSetCookieHeader()
    {
        ...
        $this->assertEquals(array(new Cookie('foo', 'bar', 0, '/', null, false, false, true), new Cookie('foo2', 'bar2', 0, '/', null, false, false, true)), $bag->getCookies());
    ...
    {
        return array(array('attachment', 'foo.html', 'foo.html', 'attachment; filename="foo.html"'), array('attachment', 'foo.html', '', 'attachment; filename="foo.html"'), array('attachment', 'foo bar.html', '', 'attachment; filename="foo bar.html"'), array('attachment', 'foo "bar".html', '', 'attachment; filename="foo \\"bar\\".html"'), array('attachment', 'foo%20bar.html', 'foo bar.html', 'attachment; filename="foo bar.html"; filename*=utf-8\'\'foo%2520bar.html'), array('attachment', 'föö.html', 'foo.html', 'attachment; filename="foo.html"; filename*=utf-8\'\'f%C3%B6%C3%B6.html'));
    }
    /**
    ...
    {
        return array(array('attachment', 'foo%20bar.html'), array('attachment', 'foo/bar.html'), array('attachment', '/foo.html'), array('attachment', 'foo\\bar.html'), array('attachment', '\\foo.html'), array('attachment', 'föö.html'));
    }
