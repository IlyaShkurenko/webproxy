...
class ResponseTest extends ResponseTestCase
{
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('Blazing\\Vpn\\Client\\Vendor\\Symfony\\Component\\HttpFoundation\\Response', $response);
    ...
    {
        $headerMock = $this->getMockBuilder('Blazing\\Vpn\\Client\\Vendor\\Symfony\\Component\\HttpFoundation\\ResponseHeaderBag')->setMethods(array('set'))->getMock();
    ...
    {
        return array(array('200', null, 'OK'), array('200', false, ''), array('200', 'foo', 'foo'), array('199', null, 'unknown status'), array('199', false, ''), array('199', 'foo', 'foo'));
    }
    ...
    {
        $response = new Response();
        $setters = array('setProtocolVersion' => '1.0', 'setCharset' => 'UTF-8', 'setPublic' => null, 'setPrivate' => null, 'setDate' => $this->createDateTimeNow(), 'expire' => null, 'setMaxAge' => 1, 'setSharedMaxAge' => 1, 'setTtl' => 1, 'setClientTtl' => 1);
    ...
    {
        return array('obj' => array(new StringableObject()), 'string' => array('Foo'), 'int' => array(2));
    }
    public function invalidContentProvider()
    {
        return array('obj' => array(new \stdClass()), 'array' => array(array()), 'bool' => array(true, '1'));
    }
    ...
    public function ianaCodesReasonPhrasesProvider()
    {
        ...
        libxml_set_streams_context(stream_context_create(array('http' => array('method' => 'GET', 'timeout' => 30))));
