...
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\RequestMatcher;
...
class RequestMatcherTest extends TestCase
{
    ...
    {
        return array(array('get', 'get', true), array('get', array('get', 'post'), true), array('get', 'post', false), array('get', 'GET', true), array('get', array('GET', 'POST'), true), array('get', 'POST', false));
    }
    ...
    {
        return array(array('.*\\.example\\.com', true), array('\\.example\\.com$', true), array('^.*\\.example\\.com$', true), array('.*\\.sensio\\.com', false), array('.*\\.example\\.COM', true), array('\\.example\\.COM$', true), array('^.*\\.example\\.COM$', true), array('.*\\.sensio\\.COM', false));
    }
