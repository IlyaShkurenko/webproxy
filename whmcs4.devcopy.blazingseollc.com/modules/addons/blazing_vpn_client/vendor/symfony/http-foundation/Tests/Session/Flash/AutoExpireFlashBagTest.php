 ...
 */
namespace Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Tests\Session\Flash;

use PHPUnit\Framework\TestCase;
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Session\Flash\AutoExpireFlashBag as FlashBag;
/**
...
class AutoExpireFlashBagTest extends TestCase
{
    ...
    public function testInitialize()
    {
        ...
        $array = array('new' => array('notice' => array('Something else'), 'error' => array('a')));
        $bag->initialize($array);
    ...
    {
        $array = array('new' => array('notice' => 'Foo', 'error' => 'Bar'));
    ...
    public function testAll()
    {
        ...
        $this->assertEquals(array('notice' => array('A previous flash message')), $this->bag->all());
