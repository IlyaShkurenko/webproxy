...
use Blazing\Vpn\Client\Vendor\Symfony\Component\HttpFoundation\Session\Storage\Handler\MemcachedSessionHandler;
/**
...
class MemcachedSessionHandlerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->storage = new MemcachedSessionHandler($this->memcached, array('prefix' => self::PREFIX, 'expiretime' => self::TTL));
    }
    ...
    {
        return array(array(array('prefix' => 'session'), true), array(array('expiretime' => 100), true), array(array('prefix' => 'session', 'expiretime' => 200), true), array(array('expiretime' => 100, 'foo' => 'bar'), false));
    }
