...
use Blazing\Vpn\Client\Vendor\Symfony\Component\Yaml\Dumper;
...
EOF;
    ...
    {
        return array('empty string' => array('', "''"), 'null' => array("\0", '"\\0"'), 'bell' => array("\7", '"\\a"'), 'backspace' => array("\10", '"\\b"'), 'horizontal-tab' => array("\t", '"\\t"'), 'line-feed' => array("\n", '"\\n"'), 'vertical-tab' => array("\v", '"\\v"'), 'form-feed' => array("\f", '"\\f"'), 'carriage-return' => array("\r", '"\\r"'), 'escape' => array("\33", '"\\e"'), 'space' => array(' ', "' '"), 'double-quote' => array('"', "'\"'"), 'slash' => array('/', '/'), 'backslash' => array('\\', '\\'), 'next-line' => array("", '"\\N"'), 'non-breaking-space' => array(" ", '"\\_"'), 'line-separator' => array(" ", '"\\L"'), 'paragraph-separator' => array(" ", '"\\P"'), 'colon' => array(':', "':'"));
    }
