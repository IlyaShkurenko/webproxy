 ...
 */
namespace Blazing\Vpn\Client\Vendor\Symfony\Component\Yaml\Command;
...
class LintCommand extends Command
{
    ...
    {
        $this->setName('lint:yaml')->setDescription('Lints a file and outputs encountered errors')->addArgument('filename', null, 'A file or a directory or STDIN')->addOption('format', null, InputOption::VALUE_REQUIRED, 'The output format', 'txt')->setHelp(<<<EOF
