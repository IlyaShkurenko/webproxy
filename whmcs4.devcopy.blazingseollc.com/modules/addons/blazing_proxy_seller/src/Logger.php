...
class Logger
{
    ...
    protected static function getInstance($userId = 0)
    {
        static $instance;
    ...
    {
        /** @var Addon $module */
        $module = Addon::getInstanceById('blazing_proxy_seller');

        $this->logger = \Blazing\Logger\Logger::createRotatingFileLogger(
