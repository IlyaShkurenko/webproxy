...
class Client
{
    ...
    )
    {
        ...
        $options = [
            ...
            CURLOPT_HTTPHEADER => ['X-Auth-Token: api-key '
                . $this->api_key,
                'Content-Type: application/json']
        ];
        if (!empty($this->enterprise_domain)) {
            $options[CURLOPT_HTTPHEADER][] = 'X-Domain: '
                . $this->enterprise_domain;
        }
        ...
        $response = new Response(
            ...
            isset($response['codeDescription']) ? $response['codeDescription']
                : null,
            $response ?: []
        );
        return $response;
