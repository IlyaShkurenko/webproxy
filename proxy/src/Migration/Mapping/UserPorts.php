...
class UserPorts
{
   ...
   * @var \DateTime
   *
   * @ORM\Column(name="time_assignment_attempt", type="datetime", nullable=true)
   */
  private $timeAssignmentAttempt;
   ...
   * @var boolean
   *
   * @ORM\Column(name="remove_order", type="boolean", nullable=false)
   */
  private $removeOrder = '0';
